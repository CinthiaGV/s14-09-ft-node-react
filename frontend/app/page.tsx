...
<main className='h-screen  section 'id='1'>
  ...
  <div className="fixed top-1/2 right-0 transform -translate-y-1/2 z-10">
    <ul className="space-y-2">
      <li>
        <a href="#1" className={`nav-dot ${activeId === '1' ? 'active' : ''}`}></a>
      </li>
      <li>
        <a href="#2" className={`nav-dot ${activeId === '2' ? 'active' : ''}`}></a>
      </li>
      <li>
        <a href="#3" className={`nav-dot ${activeId === '3' ? 'active' : ''}`}></a>
      </li>
      <li>
        <a href="#4" className={`nav-dot ${activeId === '4' ? 'active' : ''}`}></a>
      </li>
    </ul>
  </div>
  ...
  <div className="text-center relative top-56 mt-10 " >
    ...
    <div className="left-0 right-0 text-center mt-36 h-screen "
      style={{
        transition: 'transform 2s ease',
  ...
  <div className='flex h-screen items-center justify-center section' id='2'>
    <div className='absolute left-4 text-center ml-10'>
      ...
      <h2 className='text-lg font-medium text-white mt-4'>Un espacio donde encontrar al match perfecto para jugar tus partidas</h2>
      <button className='btn yellowBtn mt-5'>
        A jugar!
      </button>
    </div>
  ...
  <div className='flex flex-col h-screen items-center justify-center section mt-56' id='3'>
    <div className='absolute text-center z-10 mb-96 '>
      <h1 className='text-7xl font-bold text-white'>Encuentra a tu Match</h1>
      <h2 className='text-lg font-medium text-white mt-4'>Podras encontrar a diferentes personas para jugar</h2>
    </div>
